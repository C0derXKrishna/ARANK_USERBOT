...
from KRISHNA import START_TIME
from KRISHNA import SUDO_USER
from KRISHNA.helper.PyroHelpers import ReplyCheck
from KRISHNA.modules.help import add_command_help
from KRISHNA.modules.bot.inline import get_readable_time
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **𝐒ᴜᴘᴘᴏʀᴛ-𝐂ʜᴀᴛ**: [|| ˹'𝐺𝑂𝑆𝑆𝐼𝑃 𝑃𝐿𝐴𝑁𝐸𝑇 '💋˼ ||](t.me/GOSIP_PLANET)\n"
        f"├• **𝐔ᴘᴅᴀᴛᴇs**: [ᴋʀɪꜱʜɴᴀ](t.me/GOSIP_PLANET)\n"
        f"└• **𝐌ᴀsᴛᴇʀ**: [KRISHNA](t.me/ITSZ_KRISH_BABE)"        
    )

@Client.on_message(
    filters.command(["alive", "krishnaop"], ".") & (filters.me | filters.user(SUDO_USER))
)
...
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/C0DERXKRISHNA")
