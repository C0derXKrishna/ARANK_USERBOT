...
from KRISHNA.helper.basic import edit_or_reply, get_text, get_user

from KRISHNA.modules.help import *

OWNER = os.environ.get("OWNER", "➥Kɾιʂԋɳα𝅽🤍᪳𝆺꯭𝅥͓𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬𝆬⎯꯭᪵̽⎯")
BIO = os.environ.get("BIO", "ɪ ᴀᴍ ᴘᴀʀᴛ ᴏғ KRISHNA @GOSIP_PLANET")
